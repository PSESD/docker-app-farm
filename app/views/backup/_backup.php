...
if (!empty($application)) {
	$extras[] = Html::a('Restore (New Instance)', ['/instance/create', 'redirect' => 'instances', 'application_id' => $application->applicationObject->id, 'from' => $backup->id], ['class' => 'btn btn-default', 'data-handler' => 'background']);
}
